...
// be found in the THIRD-PARTY file.
...
fn bindgen_test_layout_mpf_intel() {
	...
	assert_eq!(
		unsafe {
			&(*(0 as *const mpf_intel)).signature as *const _ as usize
		},
		0usize,
		concat!(
			"Alignment of field: ",
	...
	assert_eq!(
		unsafe {
			&(*(0 as *const mpf_intel)).physptr as *const _ as usize
		},
		4usize,
		concat!(
			"Alignment of field: ",
	...
	assert_eq!(
		unsafe {
			&(*(0 as *const mpf_intel)).length as *const _ as usize
		},
		8usize,
		concat!(
			"Alignment of field: ",
	...
	assert_eq!(
		unsafe {
			&(*(0 as *const mpf_intel)).specification as *const _
				as usize
		},
		9usize,
		concat!(
	...
	assert_eq!(
		unsafe {
			&(*(0 as *const mpf_intel)).checksum as *const _ as usize
		},
		10usize,
		concat!(
			"Alignment of field: ",
	...
	assert_eq!(
		unsafe {
			&(*(0 as *const mpf_intel)).feature1 as *const _ as usize
		},
		11usize,
		concat!(
			"Alignment of field: ",
	...
	assert_eq!(
		unsafe {
			&(*(0 as *const mpf_intel)).feature2 as *const _ as usize
		},
		12usize,
		concat!(
			"Alignment of field: ",
	...
	assert_eq!(
		unsafe {
			&(*(0 as *const mpf_intel)).feature3 as *const _ as usize
		},
		13usize,
		concat!(
			"Alignment of field: ",
	...
	assert_eq!(
		unsafe {
			&(*(0 as *const mpf_intel)).feature4 as *const _ as usize
		},
		14usize,
		concat!(
			"Alignment of field: ",
	...
	assert_eq!(
		unsafe {
			&(*(0 as *const mpf_intel)).feature5 as *const _ as usize
		},
		15usize,
		concat!(
			"Alignment of field: ",
...
fn bindgen_test_layout_mpc_table() {
	...
	assert_eq!(
		unsafe {
			&(*(0 as *const mpc_table)).signature as *const _ as usize
		},
		0usize,
		concat!(
			"Alignment of field: ",
	...
	assert_eq!(
		unsafe {
			&(*(0 as *const mpc_table)).length as *const _ as usize
		},
		4usize,
		concat!(
			"Alignment of field: ",
	...
	assert_eq!(
		unsafe {
			&(*(0 as *const mpc_table)).spec as *const _ as usize
		},
		6usize,
		concat!(
			"Alignment of field: ",
	...
	assert_eq!(
		unsafe {
			&(*(0 as *const mpc_table)).checksum as *const _ as usize
		},
		7usize,
		concat!(
			"Alignment of field: ",
	...
	assert_eq!(
		unsafe {
			&(*(0 as *const mpc_table)).productid as *const _ as usize
		},
		16usize,
		concat!(
			"Alignment of field: ",
	...
	assert_eq!(
		unsafe {
			&(*(0 as *const mpc_table)).oemptr as *const _ as usize
		},
		28usize,
		concat!(
			"Alignment of field: ",
	...
	assert_eq!(
		unsafe {
			&(*(0 as *const mpc_table)).oemsize as *const _ as usize
		},
		32usize,
		concat!(
			"Alignment of field: ",
	...
	assert_eq!(
		unsafe {
			&(*(0 as *const mpc_table)).oemcount as *const _ as usize
		},
		34usize,
		concat!(
			"Alignment of field: ",
	...
	assert_eq!(
		unsafe {
			&(*(0 as *const mpc_table)).lapic as *const _ as usize
		},
		36usize,
		concat!(
			"Alignment of field: ",
	...
	assert_eq!(
		unsafe {
			&(*(0 as *const mpc_table)).reserved as *const _ as usize
		},
		40usize,
		concat!(
			"Alignment of field: ",
...
fn bindgen_test_layout_mpc_cpu() {
	...
	assert_eq!(
		unsafe {
			&(*(0 as *const mpc_cpu)).apicid as *const _ as usize
		},
		1usize,
		concat!(
			"Alignment of field: ",
	...
	assert_eq!(
		unsafe {
			&(*(0 as *const mpc_cpu)).apicver as *const _ as usize
		},
		2usize,
		concat!(
			"Alignment of field: ",
	...
	assert_eq!(
		unsafe {
			&(*(0 as *const mpc_cpu)).cpuflag as *const _ as usize
		},
		3usize,
		concat!(
			"Alignment of field: ",
	...
	assert_eq!(
		unsafe {
			&(*(0 as *const mpc_cpu)).cpufeature as *const _ as usize
		},
		4usize,
		concat!(
			"Alignment of field: ",
	...
	assert_eq!(
		unsafe {
			&(*(0 as *const mpc_cpu)).featureflag as *const _ as usize
		},
		8usize,
		concat!(
			"Alignment of field: ",
	...
	assert_eq!(
		unsafe {
			&(*(0 as *const mpc_cpu)).reserved as *const _ as usize
		},
		12usize,
		concat!(
			"Alignment of field: ",
...
fn bindgen_test_layout_mpc_bus() {
	...
	assert_eq!(
		unsafe {
			&(*(0 as *const mpc_bus)).bustype as *const _ as usize
		},
		2usize,
		concat!(
			"Alignment of field: ",
...
fn bindgen_test_layout_mpc_ioapic() {
	...
	assert_eq!(
		unsafe {
			&(*(0 as *const mpc_ioapic)).type_ as *const _ as usize
		},
		0usize,
		concat!(
			"Alignment of field: ",
	...
	assert_eq!(
		unsafe {
			&(*(0 as *const mpc_ioapic)).apicid as *const _ as usize
		},
		1usize,
		concat!(
			"Alignment of field: ",
	...
	assert_eq!(
		unsafe {
			&(*(0 as *const mpc_ioapic)).apicver as *const _ as usize
		},
		2usize,
		concat!(
			"Alignment of field: ",
	...
	assert_eq!(
		unsafe {
			&(*(0 as *const mpc_ioapic)).flags as *const _ as usize
		},
		3usize,
		concat!(
			"Alignment of field: ",
	...
	assert_eq!(
		unsafe {
			&(*(0 as *const mpc_ioapic)).apicaddr as *const _ as usize
		},
		4usize,
		concat!(
			"Alignment of field: ",
...
fn bindgen_test_layout_mpc_intsrc() {
	...
	assert_eq!(
		unsafe {
			&(*(0 as *const mpc_intsrc)).type_ as *const _ as usize
		},
		0usize,
		concat!(
			"Alignment of field: ",
	...
	assert_eq!(
		unsafe {
			&(*(0 as *const mpc_intsrc)).irqtype as *const _ as usize
		},
		1usize,
		concat!(
			"Alignment of field: ",
	...
	assert_eq!(
		unsafe {
			&(*(0 as *const mpc_intsrc)).irqflag as *const _ as usize
		},
		2usize,
		concat!(
			"Alignment of field: ",
	...
	assert_eq!(
		unsafe {
			&(*(0 as *const mpc_intsrc)).srcbus as *const _ as usize
		},
		4usize,
		concat!(
			"Alignment of field: ",
	...
	assert_eq!(
		unsafe {
			&(*(0 as *const mpc_intsrc)).dstapic as *const _ as usize
		},
		6usize,
		concat!(
			"Alignment of field: ",
	...
	assert_eq!(
		unsafe {
			&(*(0 as *const mpc_intsrc)).dstirq as *const _ as usize
		},
		7usize,
		concat!(
			"Alignment of field: ",
...
fn bindgen_test_layout_mpc_lintsrc() {
	...
	assert_eq!(
		unsafe {
			&(*(0 as *const mpc_lintsrc)).type_ as *const _ as usize
		},
		0usize,
		concat!(
			"Alignment of field: ",
	...
	assert_eq!(
		unsafe {
			&(*(0 as *const mpc_lintsrc)).irqtype as *const _ as usize
		},
		1usize,
		concat!(
			"Alignment of field: ",
	...
	assert_eq!(
		unsafe {
			&(*(0 as *const mpc_lintsrc)).irqflag as *const _ as usize
		},
		2usize,
		concat!(
			"Alignment of field: ",
	...
	assert_eq!(
		unsafe {
			&(*(0 as *const mpc_lintsrc)).destapiclint as *const _
				as usize
		},
		7usize,
		concat!(
...
fn bindgen_test_layout_mpc_oemtable() {
	...
	assert_eq!(
		unsafe {
			&(*(0 as *const mpc_oemtable)).length as *const _ as usize
		},
		4usize,
		concat!(
			"Alignment of field: ",
	...
	assert_eq!(
		unsafe {
			&(*(0 as *const mpc_oemtable)).rev as *const _ as usize
		},
		6usize,
		concat!(
			"Alignment of field: ",
	...
	assert_eq!(
		unsafe {
			&(*(0 as *const mpc_oemtable)).mpc as *const _ as usize
		},
		8usize,
		concat!(
			"Alignment of field: ",
